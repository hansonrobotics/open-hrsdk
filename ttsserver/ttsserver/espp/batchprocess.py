import numpy as np
from . import analysis as alysis
...
def batch_synthesis(
    ...
    if emotion == "sad":
        output = synth.sad_patch(fs, semitones, cutfreq, gain, tempo, parameter_control)
    ...
    if emotion == "afraid":
        ...
        output = synth.afraid_patch(
            fs, utterance_time_stamps, speed, depth, tempo, intensity, parameter_control
        )
    return output
